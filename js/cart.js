...
var shoppingCart = (function() {
  ...
  function displayCart() {
    ...
    for(var i in cartArray) {
      output += "<tr>"
      + "<td><a href='#''><i class='far fa-times-circle delete-item' data-name='" + cartArray[i].name +"'></i></a></td>"
  ...
  function setVal(){
    const val = document.getElementById('itemPrice').value;
    document.getElementById("place-bid").setAttribute("data-price",val);
  }
//return input value
